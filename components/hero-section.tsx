        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl text-balance font-mono">
              Vivez les <span className="text-primary">Jeux Olympiques</span> de
              Paris 2024
            </h1>

            <p className="text-lg text-muted-foreground max-w-lg leading-relaxed">
              Soyez au cœur de l'action. Réservez vos places pour assister aux
              plus grands athlètes du monde dans la ville lumière.
            </p>
